...
public class CommentsTemplate_5_0 extends LinearLayout {
    private View view;
    private ImageView imageView0, imageView1, imageView2, imageView3, imageView4;

    public CommentsTemplate_5_0(Context context) {
        super(context);
        view = inflate(context, R.layout.template_comments_5_0, this);
    ...
    public void setImageUrl(List<String> urlList) {
        if (null != urlList && urlList.size() == 5) {
