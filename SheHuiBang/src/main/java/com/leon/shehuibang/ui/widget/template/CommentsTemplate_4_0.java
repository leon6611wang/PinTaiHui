...
public class CommentsTemplate_4_0 extends LinearLayout {
    private View view;
    private ImageView imageView0, imageView1, imageView2,imageView3;

    public CommentsTemplate_4_0(Context context) {
        super(context);
        view = inflate(context, R.layout.template_comments_4_0, this);
