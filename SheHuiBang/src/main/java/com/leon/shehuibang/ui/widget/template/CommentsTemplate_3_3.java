...
public class CommentsTemplate_3_3 extends LinearLayout {
    private View view;
    private ImageView imageView0, imageView1, imageView2;

    public CommentsTemplate_3_3(Context context) {
        super(context);
        view = inflate(context, R.layout.template_comments_3_3, this);
