...
public class CommentsTemplate_3_0 extends LinearLayout {
    private View view;
    private ImageView imageView0, imageView1, imageView2;

    public CommentsTemplate_3_0(Context context) {
        super(context);
        view = inflate(context, R.layout.template_comments_3_0, this);
