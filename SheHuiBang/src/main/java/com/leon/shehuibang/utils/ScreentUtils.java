...
public class ScreentUtils {
    private static ScreentUtils utils;

    public static ScreentUtils getInstance() {
        if (null == utils) {
            utils = new ScreentUtils();
        }
        return utils;
    }
     ...
     */
    public void setStatusBarLightMode(Activity activity, boolean dark) {
