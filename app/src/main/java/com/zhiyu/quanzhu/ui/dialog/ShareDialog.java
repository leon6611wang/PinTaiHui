...
//                    onShareListener.onShare(1, "inner");
//                    dismiss();
//                }
...
//                if (null != onShareListener) {
//                    onShareListener.onShare(2, "wechat_circle");
//                    dismiss();
//                }
...
//                if (null != onShareListener) {
//                    onShareListener.onShare(3, "wechat");
//                    dismiss();
//                }
...
//                if (null != onShareListener) {
//                    onShareListener.onShare(4, "qq");
//                    dismiss();
//                }
                ShareUtils.getInstance(activity).shareToQQ();
                break;
