...
public class MyCollectionShopGoodsAdapter extends BaseAdapter {
    ...
    public MyCollectionShopGoodsAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_my_collection_shop_goods, null);
