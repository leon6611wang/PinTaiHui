...
public class InnerShareQuanYouAdapter extends BaseExpandableListAdapter implements IDockingController {
    ...
    public InnerShareQuanYouAdapter(Context context, ExpandableListView listView) {
        mContext = context;
        mListView = listView;
    }
    ...
    private class OnSelectClick implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (null != shareInnerSelectListener) {
                String name = StringUtils.isNullOrEmpty(list.get(groupPosition).get(childPosition).getNotename()) ? list.get(groupPosition).get(childPosition).getCard_name() : list.get(groupPosition).get(childPosition).getNotename();
                shareInnerSelectListener.onSelect(list.get(groupPosition).get(childPosition).getCard_thumb(),name,
                        list.get(groupPosition).get(childPosition).isSelected(),false);
            }
        }
    }
