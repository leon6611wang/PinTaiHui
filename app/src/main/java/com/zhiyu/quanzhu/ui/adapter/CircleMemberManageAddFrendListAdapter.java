...
public class CircleMemberManageAddFrendListAdapter extends BaseExpandableListAdapter implements IDockingController {

    private Context mContext;
    private ExpandableListView mListView;
    private List<List<CardFrend>> list;

    public void setList(List<List<CardFrend>> frendList) {
        this.list = frendList;
        notifyDataSetChanged();
    }

    public CircleMemberManageAddFrendListAdapter(Context context, ExpandableListView listView) {
        mContext = context;
        mListView = listView;
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        String name = StringUtils.isNullOrEmpty(list.get(groupPosition).get(childPosition).getNotename()) ? list.get(groupPosition).get(childPosition).getCard_name() : list.get(groupPosition).get(childPosition).getNotename() + "[" + list.get(groupPosition).get(childPosition).getCard_name() + "]";
    ...
    private List<CardFrend> selectedList = new ArrayList<>();
    ...
    public interface OnSelectedCardFrendListener {
        void OnSelectedCardFrend(List<CardFrend> list);
    }
