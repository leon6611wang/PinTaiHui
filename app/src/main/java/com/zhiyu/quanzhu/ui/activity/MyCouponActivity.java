...
import com.zhiyu.quanzhu.ui.fragment.FragmentMyCouponShiYongJiLu;
import com.zhiyu.quanzhu.ui.fragment.FragmentMyCouponWeiShiYong;
import com.zhiyu.quanzhu.ui.fragment.FragmentMyCouponYiGuoQi;
...
public class MyCouponActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initViews() {
        ...
        fragmentList.add(new FragmentMyCouponWeiShiYong());
        fragmentList.add(new FragmentMyCouponYiGuoQi());
        fragmentList.add(new FragmentMyCouponShiYongJiLu());
