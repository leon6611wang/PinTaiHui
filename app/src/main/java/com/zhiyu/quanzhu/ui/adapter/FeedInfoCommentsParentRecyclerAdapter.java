 ...
 * 动态详情评论-父级
 */
public class FeedInfoCommentsParentRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    ...
    private static class MyHandler extends Handler {
        WeakReference<FeedInfoCommentsParentRecyclerAdapter> adapterWeakReference;

        public MyHandler(FeedInfoCommentsParentRecyclerAdapter adapter) {
            adapterWeakReference = new WeakReference<>(adapter);
        }

        @Override
        public void handleMessage(Message msg) {
            FeedInfoCommentsParentRecyclerAdapter adapter = adapterWeakReference.get();
            switch (msg.what) {
                case 1:
    ...
    public FeedInfoCommentsParentRecyclerAdapter(Context context, MyLocationRecyclerView recyclerView) {
...
//            adapter.addList(list);
    ...
    private void childComments(int comment_id) {
        RequestParams params = MyRequestParams.getInstance(context).getRequestParams(ConstantsUtils.BASE_URL + ConstantsUtils.REPLY_COMMENT);
