 ...
 * 我的卡券-未使用-即将失效
 */
public class FragmentMyCouponWeiShiYongShiXiao extends Fragment {
    private View view;
    ...
    private static class MyHandler extends Handler {
        WeakReference<FragmentMyCouponWeiShiYongShiXiao> fragmentKaQuanWeiShiYongShiXiaoWeakReference;

        public MyHandler(FragmentMyCouponWeiShiYongShiXiao fragmentMyCouponWeiShiYongShiXiao) {
            fragmentKaQuanWeiShiYongShiXiaoWeakReference = new WeakReference<>(fragmentMyCouponWeiShiYongShiXiao);
        }

        @Override
        public void handleMessage(Message msg) {
            FragmentMyCouponWeiShiYongShiXiao fragment = fragmentKaQuanWeiShiYongShiXiaoWeakReference.get();
            switch (msg.what) {
                case 1:
    ...
    private int type=2;// 1全部未使用的 2未使用且即将过期 3已过期 4已使用
    ...
    private void myCoupons(){
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                System.out.println("未使用-失效: "+result);
