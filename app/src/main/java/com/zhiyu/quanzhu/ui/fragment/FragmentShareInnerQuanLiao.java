...
public class FragmentShareInnerQuanLiao extends Fragment {
    private View view;
    private PtrFrameLayout ptrFrameLayout;
    private RecyclerView mRecyclerView;
    private InnerShareQuanLiaoAdapter adapter;
    private MyHandler myHandler = new MyHandler(this);

    private static class MyHandler extends Handler {
        WeakReference<FragmentShareInnerQuanLiao> weakReference;

        public MyHandler(FragmentShareInnerQuanLiao fragment) {
            weakReference = new WeakReference<>(fragment);
        }

        @Override
        public void handleMessage(Message msg) {
            FragmentShareInnerQuanLiao fragment = weakReference.get();
            switch (msg.what) {
                case 1:
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_share_inner_quanliao, null);
        initPtr();
        initViews();
        return view;
    }
    ...
    private void initViews() {
        ...
        adapter = new InnerShareQuanLiaoAdapter(getContext());
