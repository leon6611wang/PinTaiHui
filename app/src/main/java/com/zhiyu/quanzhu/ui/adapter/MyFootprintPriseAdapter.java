 ...
 * 首页-圈子-关注列表适配器
 */
public class MyFootprintPriseAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static class MyHandler extends Handler {
        WeakReference<MyFootprintPriseAdapter> adapterWeakReference;

        public MyHandler(MyFootprintPriseAdapter adapter) {
