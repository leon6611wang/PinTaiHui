 ...
 * 我的卡券-未使用-全部
 */
public class FragmentKaQuanWeiShiYongQuanBu extends Fragment {
    private View view;
    ...
    private static class MyHandler extends Handler {
        WeakReference<FragmentKaQuanWeiShiYongQuanBu> fragmentKaQuanWeiShiYongQuanBuWeakReference;

        public MyHandler(FragmentKaQuanWeiShiYongQuanBu fragmentKaQuanWeiShiYongQuanBu) {
            fragmentKaQuanWeiShiYongQuanBuWeakReference = new WeakReference<>(fragmentKaQuanWeiShiYongQuanBu);
        }

        @Override
        public void handleMessage(Message msg) {
            FragmentKaQuanWeiShiYongQuanBu fragment = fragmentKaQuanWeiShiYongQuanBuWeakReference.get();
            switch (msg.what) {
                case 1:
