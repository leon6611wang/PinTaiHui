...
public class HorizontalRecyclerViewGroup extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public HorizontalRecyclerViewGroup(Context context) {
        super(context);
    }

    public HorizontalRecyclerViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HorizontalRecyclerViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
