...
public class MyShangQuanMenuDialog extends Dialog implements View.OnClickListener {
    ...
    private LinearLayout saoyisaolayout, chuangquanlayout, tianjialayout, mingpianlayout, yaoqinglayout;

    public MyShangQuanMenuDialog(@NonNull Context context, int themeResId, OnMenuSelectedListener listener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_my_shangquan_menu);
