...
import com.zhiyu.quanzhu.ui.adapter.QianBaoRecyclerAdapter;
...
public class QianBaoActivity extends BaseActivity implements View.OnClickListener {
    ...
    private QianBaoRecyclerAdapter adapter;
    ...
    private static class MyHandler extends Handler {
        WeakReference<QianBaoActivity> qianBaoActivityWeakReference;

        public MyHandler(QianBaoActivity activity) {
            qianBaoActivityWeakReference = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            QianBaoActivity activity = qianBaoActivityWeakReference.get();
            switch (msg.what) {
                case 1:
    ...
    private void initDialogs() {
        startDateDialog = new CalendarDialog(this, R.style.dialog, new CalendarDialog.OnCalendarListener() {
            @Override
            public void onCalendar(int year, int month, int day) {
                startDateTextView.setText(month + "月" + day + "日 " + year);
            }
        });
        endDateDialog = new CalendarDialog(this, R.style.dialog, new CalendarDialog.OnCalendarListener() {
            @Override
            public void onCalendar(int year, int month, int day) {
    ...
    private void initViews() {
        ...
        adapter = new QianBaoRecyclerAdapter();
        ...
        rightView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent bankcardIntent = new Intent(QianBaoActivity.this, BankCardListActivity.class);
        ...
        mHeaderView.getViewTreeObserver().addOnPreDrawListener(
                new ViewTreeObserver.OnPreDrawListener() {
                    ...
                    public boolean onPreDraw() {
                        ...
                        viewpagerheight = screenheight - headerviewheight;
...
//                        viewpagerheight -= menuviewheight;
