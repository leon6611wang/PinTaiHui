 ...
 * 我的收藏-文章
 */
public class FragmentMyCollectionArticle extends Fragment {
    private View view;
    private MyCollectionArticleAdapter adapter;
    private RecyclerView recyclerView;
    private PtrFrameLayout ptrFrameLayout;
    private MyHandler myHandler = new MyHandler(this);

    private static class MyHandler extends Handler {
        WeakReference<FragmentMyCollectionArticle> fragmentWeakReference;

        public MyHandler(FragmentMyCollectionArticle fragment) {
            fragmentWeakReference = new WeakReference<>(fragment);
        }

        @Override
        public void handleMessage(Message msg) {
            FragmentMyCollectionArticle fragment = fragmentWeakReference.get();
            switch (msg.what) {
                case 1:
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_my_collection_article, null);
        initPtr();
        initViews();
        return view;
    }
    ...
    private void initViews() {
        ...
        adapter = new MyCollectionArticleAdapter(getActivity(), getContext());
    ...
    private String type = "article";//类型 article文章 cards名片 video视频 goods商品 store店铺
    private int page = 1;
...
//                System.out.println("article: "+ex.toString());
            }
