...
public class ArticleInfoCommentListChildAdapter extends BaseAdapter {
    private List<FeedCommentChild> list;
    private Context context;
    private MyHandler myHandler = new MyHandler(this);

    private static class MyHandler extends Handler {
        WeakReference<ArticleInfoCommentListChildAdapter> adapterWeakReference;

        public MyHandler(ArticleInfoCommentListChildAdapter adapter) {
    ...
    public ArticleInfoCommentListChildAdapter(Context context) {
