...
public class ShenSuPingZhengImageRecyclerViewAdapter extends RecyclerView.Adapter<ShenSuPingZhengImageRecyclerViewAdapter.ViewHolder> {
    private List<String> list;
    private Context context;
    private LinearLayout.LayoutParams ll;

    public ShenSuPingZhengImageRecyclerViewAdapter(Context context) {
