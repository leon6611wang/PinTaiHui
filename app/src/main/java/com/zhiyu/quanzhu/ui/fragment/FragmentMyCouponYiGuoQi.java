...
public class FragmentMyCouponYiGuoQi extends Fragment {
    private View view;
    ...
    private static class MyHandler extends Handler {
        WeakReference<FragmentMyCouponYiGuoQi> fragmentKaQuanYiGuoQiWeakReference;

        public MyHandler(FragmentMyCouponYiGuoQi fragmentMyCouponYiGuoQi) {
            fragmentKaQuanYiGuoQiWeakReference = new WeakReference<>(fragmentMyCouponYiGuoQi);
        }

        @Override
        public void handleMessage(Message msg) {
            FragmentMyCouponYiGuoQi fragment = fragmentKaQuanYiGuoQiWeakReference.get();
            switch (msg.what) {
                case 1:
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_kaquan_yiguoqi, null);
        initViews();
        return view;
    }
    ...
    private int type = 3;// 1全部未使用的 2未使用且即将过期 3已过期 4已使用
