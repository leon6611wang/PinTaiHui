...
public class ShangPinInfoYouHuiQuanRecyclerAdapter extends RecyclerView.Adapter<ShangPinInfoYouHuiQuanRecyclerAdapter.ViewHolder> {
    private List<GoodsCoupon> list;
    private Context context;
    private LinearLayout.LayoutParams leftParams,rightParams;
    public ShangPinInfoYouHuiQuanRecyclerAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_shangpin_information_youhuiquan, null));
    }
