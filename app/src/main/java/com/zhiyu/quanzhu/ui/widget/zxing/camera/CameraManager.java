...
package com.zhiyu.quanzhu.ui.widget.zxing.camera;
...
public final class CameraManager {
	...
	public synchronized Rect getFramingRect() {
		if (framingRect == null) {
			...
			int wh=(int)context.getResources().getDimension(R.dimen.dp_200);
			int leftOffset = (screenResolution.x - wh) / 2;
			int topOffset = (screenResolution.y - wh) / 5*2;
			framingRect = new Rect(leftOffset, topOffset, leftOffset + wh,
					topOffset + wh);
