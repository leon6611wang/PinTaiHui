 ...
 * 商圈详情-右上角菜单-圈主
 */
public class ShangQuanInformationRightMenuQuanZhuWindow extends PopupWindow implements View.OnClickListener {
    private Context context;

    public ShangQuanInformationRightMenuQuanZhuWindow(Context context) {
        super(context);
