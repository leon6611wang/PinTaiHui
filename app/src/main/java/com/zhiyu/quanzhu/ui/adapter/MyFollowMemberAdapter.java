...
public class MyFollowMemberAdapter extends BaseAdapter {
    private List<FollowMember> list;
    private Context context;
    private MyHandler myHandler = new MyHandler(this);

    private static class MyHandler extends Handler {
        WeakReference<MyFollowMemberAdapter> adapterWeakReference;

        public MyHandler(MyFollowMemberAdapter adapter) {
            adapterWeakReference = new WeakReference<>(adapter);
        }

        @Override
        public void handleMessage(Message msg) {
            MyFollowMemberAdapter adapter = adapterWeakReference.get();
            switch (msg.what) {
                case 1:
    ...
    public MyFollowMemberAdapter(Context context) {
        this.context = context;
    }

    public void setList(List<FollowMember> fansList) {
        this.list = fansList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_follow_member, null);
