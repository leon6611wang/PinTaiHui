 ...
 * 系统消息-关注店铺
 */
public class XiTongXiaoXiGuanZhuDianPuActivity extends BaseActivity implements View.OnClickListener {
    private LinearLayout backLayout;
    private TextView titleTextView;
    private PtrFrameLayout ptrFrameLayout;
    private RecyclerView mRecyclerView;
    private XiTongXiaoXiGuanZhuDianPuRecyclerAdapter adapter;
    private MyHandler myHandler=new MyHandler(this);
    private static class MyHandler extends Handler{
        WeakReference<XiTongXiaoXiGuanZhuDianPuActivity> activityWeakReference;
        public MyHandler(XiTongXiaoXiGuanZhuDianPuActivity activity){
            activityWeakReference=new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            XiTongXiaoXiGuanZhuDianPuActivity activity=activityWeakReference.get();
            switch (msg.what){
                case 1:
