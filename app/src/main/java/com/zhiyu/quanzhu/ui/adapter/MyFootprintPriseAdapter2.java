 ...
 * 个人中心-我的足迹-点赞
 */
public class MyFootprintPriseAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyFootprintPriseAdapter2(Activity aty, final Context context) {
    ...
    private static class MyHandler extends Handler {
        WeakReference<MyFootprintPriseAdapter2> adapterWeakReference;

        public MyHandler(MyFootprintPriseAdapter2 adapter) {
            adapterWeakReference = new WeakReference<>(adapter);
        }

        @Override
        public void handleMessage(Message msg) {
            MyFootprintPriseAdapter2 adapter = adapterWeakReference.get();
            switch (msg.what) {
                case 1:
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == FEED) {
            return new FeedViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_my_footprint_prise_feed, parent, false));
        } else if (viewType == ARTICLE) {
            return new ArticleViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_my_footprint_prise_article, parent, false));
        } else if (viewType == VIDEO) {
            return new VideoViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_my_footprint_prise_video, parent, false));
        }
        return null;
    }
