...
public class FullSearchShopListAdapter extends BaseAdapter {
    private List<FullSearchShop> list;
    private Context context;

    public FullSearchShopListAdapter(Context context) {
    ...
    class ViewHolder {
        ...
        FullSearchShopGoodsListAdapter adapter;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            holder.adapter = new FullSearchShopGoodsListAdapter(parent.getContext());
        ...
        if(null!=list.get(position).getGoods_list()&&list.get(position).getGoods_list().size()>0){
