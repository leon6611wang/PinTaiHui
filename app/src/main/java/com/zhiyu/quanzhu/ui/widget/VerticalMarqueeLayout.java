...
public class VerticalMarqueeLayout extends ViewAnimator {
            ...
            if (this.views.size() > 1) {
                handler.postDelayed(new Runnable() {
                    public void run() {
                        ...
                        if(null!=onDeliveryChangeListener){
                            onDeliveryChangeListener.onDeliveryChange(viewIndex);
                        }
                        showNext();
    ...
    private OnDeliveryChangeListener onDeliveryChangeListener;
    public void setOnDeliveryChangeListener(OnDeliveryChangeListener listener){
        this.onDeliveryChangeListener=listener;
    }
    public interface OnDeliveryChangeListener{
        void onDeliveryChange(int index);
    }
}
