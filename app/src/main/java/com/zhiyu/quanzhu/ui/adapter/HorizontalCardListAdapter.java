...
public class HorizontalCardListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HorizontalCardListAdapter(Activity activity) {
...
//            bottomCardView.setLayoutParams(bottomCardLayoutParams);
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder mHolder, final int position) {
        if (mHolder instanceof QuanZiTuiJianAdapter.WenZhangViewHolder) {
            QuanZiTuiJianAdapter.WenZhangViewHolder holder = (QuanZiTuiJianAdapter.WenZhangViewHolder) mHolder;
            holder.mWebView.loadUrl(list.get(position).getContent().getLink_url());
        } else if (mHolder instanceof QuanZiTuiJianAdapter.DuoTuViewHolder) {
            QuanZiTuiJianAdapter.DuoTuViewHolder holder = (QuanZiTuiJianAdapter.DuoTuViewHolder) mHolder;
        ...
        } else if (mHolder instanceof QuanZiTuiJianAdapter.DanTuHasTextViewHolder) {
            final QuanZiTuiJianAdapter.DanTuHasTextViewHolder holder = (QuanZiTuiJianAdapter.DanTuHasTextViewHolder) mHolder;
        ...
        } else if (mHolder instanceof QuanZiTuiJianAdapter.DanTuNoTextViewHolder) {
            final QuanZiTuiJianAdapter.DanTuNoTextViewHolder holder = (QuanZiTuiJianAdapter.DanTuNoTextViewHolder) mHolder;
            if (null != list.get(position).getContent().getImgs() && list.get(position).getContent().getImgs().size() > 0) {
        ...
        } else if (mHolder instanceof QuanZiTuiJianAdapter.XingQuViewHolder) {
            QuanZiTuiJianAdapter.XingQuViewHolder holder = (QuanZiTuiJianAdapter.XingQuViewHolder) mHolder;
        ...
        } else if (mHolder instanceof QuanZiTuiJianAdapter.ViewHViewHolder) {
            QuanZiTuiJianAdapter.ViewHViewHolder holder = (QuanZiTuiJianAdapter.ViewHViewHolder) mHolder;
//            System.out.println("横视频" + position + " , type: " + list.get(position).getType());

        } else if (mHolder instanceof QuanZiTuiJianAdapter.VideoVViewHolder) {
            final QuanZiTuiJianAdapter.VideoVViewHolder holder = (QuanZiTuiJianAdapter.VideoVViewHolder) mHolder;
...
//                System.gc();
    ...
    private QuanZiTuiJianAdapter.OnChangeXingQuListener onChangeXingQuListener;

    public void setOnChangeXingQuListener(QuanZiTuiJianAdapter.OnChangeXingQuListener listener) {
