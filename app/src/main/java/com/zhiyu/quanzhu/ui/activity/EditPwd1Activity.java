 ...
 * 我的-设置-账号与安全-修改密码1
 */
public class EditPwd1Activity extends BaseActivity implements View.OnClickListener {
    ...
    private static class MyHandler extends Handler {
        WeakReference<EditPwd1Activity> editPwd1ActivityWeakReference;

        public MyHandler(EditPwd1Activity activity) {
            editPwd1ActivityWeakReference = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            EditPwd1Activity activity = editPwd1ActivityWeakReference.get();
            switch (msg.what) {
                case 0:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_pwd1);
        initViews();
        initTimerTask();
    }
