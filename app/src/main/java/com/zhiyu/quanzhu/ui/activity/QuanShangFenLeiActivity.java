 ...
 * 圈商分类
 */
public class QuanShangFenLeiActivity extends BaseActivity implements View.OnClickListener,QuanShangFenLeiRecyclerViewLeftAdapter.OnLeftClickListener {
    ...
    private static class MyHandler extends Handler {
        WeakReference<QuanShangFenLeiActivity> activityWeakReference;

        public MyHandler(QuanShangFenLeiActivity activity) {
            activityWeakReference = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            QuanShangFenLeiActivity activity = activityWeakReference.get();
            switch (msg.what) {
                case 1:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quanshang_fenlei);
