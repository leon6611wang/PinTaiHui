...
public class MyListViewWrapLayout extends FrameLayout implements View.OnClickListener {
    ...
    private static class MyHandler extends Handler {
        WeakReference<MyListViewWrapLayout> layoutWeakReference;

        public MyHandler(MyListViewWrapLayout layout) {
            layoutWeakReference = new WeakReference<>(layout);
        }

        @Override
        public void handleMessage(Message msg) {
            MyListViewWrapLayout layout = layoutWeakReference.get();
            switch (msg.what) {
                case 10001:
    ...
    public MyListViewWrapLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initViews() {
        listView = LayoutInflater.from(context).inflate(R.layout.widget_wrap_layout_listview, null);
        initPtr();
