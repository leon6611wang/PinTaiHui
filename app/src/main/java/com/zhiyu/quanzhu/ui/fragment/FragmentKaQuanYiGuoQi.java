...
public class FragmentKaQuanYiGuoQi extends Fragment {
    private View view;
    ...
    private static class MyHandler extends Handler {
        WeakReference<FragmentKaQuanYiGuoQi> fragmentKaQuanYiGuoQiWeakReference;

        public MyHandler(FragmentKaQuanYiGuoQi fragmentKaQuanYiGuoQi) {
            fragmentKaQuanYiGuoQiWeakReference = new WeakReference<>(fragmentKaQuanYiGuoQi);
        }

        @Override
        public void handleMessage(Message msg) {
            FragmentKaQuanYiGuoQi fragment = fragmentKaQuanYiGuoQiWeakReference.get();
            switch (msg.what) {
                case 1:
