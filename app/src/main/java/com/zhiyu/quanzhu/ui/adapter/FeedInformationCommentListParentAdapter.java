...
public class FeedInformationCommentListParentAdapter extends BaseAdapter implements ArticleInfoCommentListChildAdapter.OnReplyChildCommentListener {
    private List<FeedCommentParent> list;
    private Context context;
    private MyHandler myHandler = new MyHandler(this);

    private static class MyHandler extends Handler {
        WeakReference<FeedInformationCommentListParentAdapter> adapterWeakReference;

        public MyHandler(FeedInformationCommentListParentAdapter adapter) {
            adapterWeakReference = new WeakReference<>(adapter);
        }

        @Override
        public void handleMessage(Message msg) {
            FeedInformationCommentListParentAdapter adapter = adapterWeakReference.get();
            switch (msg.what) {
                case 1:
    ...
    public FeedInformationCommentListParentAdapter(Context context) {
