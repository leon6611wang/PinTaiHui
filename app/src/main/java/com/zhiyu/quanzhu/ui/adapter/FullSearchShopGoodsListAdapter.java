...
public class FullSearchShopGoodsListAdapter extends BaseAdapter {
    ...
    public FullSearchShopGoodsListAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_full_search_shop_goods, null);
