 ...
 * 圈聊-右侧商品菜单
 */
public class IMRightMenuDialog2 extends Dialog implements View.OnClickListener {
    ...
    private static class MyHandler extends Handler {
        WeakReference<IMRightMenuDialog2> imRightMenuDialogWeakReference;

        public MyHandler(IMRightMenuDialog2 dialog) {
            imRightMenuDialogWeakReference = new WeakReference<>(dialog);
        }

        @Override
        public void handleMessage(Message msg) {
            IMRightMenuDialog2 dialog = imRightMenuDialogWeakReference.get();
            switch (msg.what) {
                case 1:
    ...
    public IMRightMenuDialog2(@NonNull Context context, int themeResId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_im_right_menu2);
