 ...
 * 圈主
 */
public class UpdateCircleProfileActivity extends BaseActivity implements View.OnClickListener {
    ...
    private static class MyHandler extends Handler {
        WeakReference<UpdateCircleProfileActivity> weakReference;

        public MyHandler(UpdateCircleProfileActivity activity) {
            weakReference = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            UpdateCircleProfileActivity activity = weakReference.get();
            switch (msg.what) {
                case 1:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_circle_profile);
