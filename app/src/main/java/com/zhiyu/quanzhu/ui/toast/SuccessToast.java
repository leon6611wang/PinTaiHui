...
public class SuccessToast {
    private static SuccessToast successToast;
    private static Context context;
    private static Toast toast;
    private static TextView msgTextView;

    public static SuccessToast getInstance(Context ctxt) {
        if (null == successToast) {
            synchronized (SuccessToast.class) {
                successToast = new SuccessToast();
                context = ctxt;
