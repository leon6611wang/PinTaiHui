...
public class CardLetterListAdapter extends BaseAdapter {
   ...
   public void setLetterList(List<String> list){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_card_letter_listview, null);
