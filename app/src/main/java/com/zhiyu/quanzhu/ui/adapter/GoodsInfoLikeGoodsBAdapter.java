...
public class GoodsInfoLikeGoodsBAdapter extends RecyclerView.Adapter<GoodsInfoLikeGoodsBAdapter.ViewHolder> {
    ...
    public GoodsInfoLikeGoodsBAdapter(Context context) {
